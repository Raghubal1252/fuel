...
class SaleOrder(models.Model):
    ...
    def get_dashboard_all_data(self, data=None):
        ...
        products = self.env['product.product'].search(
            [('sale_ok', '=', True), ('purchase_ok', '=', True), ('type', '=', 'consu'), ('is_storable', '=', True)])

        all_products = [
            {'name': i.name, 'd_n': i.display_name, 'id': i.id, 'product_templ_id': i.product_tmpl_id,
        ...
        for product in all_products:
            ...
            for purchase in purchase_order:
                for line in purchase.order_line:
                    print('===yyyyyyyyyyyyy=========',product['name'] ,'and',line.product_id.name)
        ...
        for i in all_products:
            if i['id'] == self.env.ref('petrol_station_dashboard.fuel_type_petrol_template').id:
            ...
            if i['id'] == self.env.ref('petrol_station_dashboard.fuel_type_Diesel_template').id:
                print('==========Diesel==========s=====')
